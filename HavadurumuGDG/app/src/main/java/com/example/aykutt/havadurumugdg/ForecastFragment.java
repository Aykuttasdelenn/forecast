package com.example.aykutt.havadurumugdg;
...
public class ForecastFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        forecastArray.add("Bugün - Güneşli 5 / 35");
        ...
        protected String[] doInBackground(String... params) {
            ...
            try {
                ...
                Uri uri = Uri.parse("http://api.openweathermap.org/data/2.5/forecast/daily/")
                        .buildUpon()
                        .appendQueryParameter("id", postcode)
                ...
                URL url = new URL("http://api.openweathermap.org/data/2.5/forecast/daily?id=745044&mode=json&units=metric&cnt=7");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        {
        FecthWeatherTask task = new FecthWeatherTask();
            task.execute("");
            return false;
        }
 ...
 */
    ...
    private String formatHighLows(double high, double low) {
        ...
        String highLowStr = " En Yüksek "+"" + roundedHigh + ""+" En Düşük "+"" + roundedLow;
        return highLowStr;
    }
